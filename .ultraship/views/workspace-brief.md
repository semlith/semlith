...
| --- | --- | --- | --- | --- |
| semlith | RELEASED | 0.4.0 | independent-product | A developer installs semlith with cargo install, indexes one repository in a single run with bounded memory, and then finds both an exact identifier and a plain-English question in that same store. |
