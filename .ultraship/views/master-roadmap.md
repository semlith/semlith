...
| 0.4.0 | A developer leaves a store current without re-running index by hand; edited files are re-embedded as they are saved, and an agent already connected over MCP searches the new contents without restarting its server. | specified | planned |
