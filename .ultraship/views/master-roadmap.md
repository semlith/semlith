...
| 0.5.0 | A developer searches several stores at once from a single query, so an agent working across repositories asks one question instead of many. | specified | planned |
